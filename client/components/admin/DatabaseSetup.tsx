    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set up the complete database schema for your pizza restaurant
            management system. This will create all necessary tables and insert
            sample data.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {errorCount > 0 && (
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <p className="text-sm text-yellow-700 mb-3">
                Some tables couldn't be created automatically. This might be due
                to permission limitations.
              </p>
              <div className="space-y-2 text-sm text-yellow-700">
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>
                    ...
                    <code>complete-supabase-schema.txt</code>
                  </li>
          ...
          {successCount === steps.length && (
            <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              <p className="text-sm text-green-700">
                All tables have been created successfully. You can now use the
                admin panel to manage your restaurant data.
              </p>
            </div>
          )}
        </CardContent>
